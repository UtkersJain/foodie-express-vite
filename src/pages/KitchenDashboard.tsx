...
import { CheckCircle, ChefHat, Truck, AlertCircle, ArrowLeft } from 'lucide-react'
                      ...
                      <div className="space-y-2 mb-4">
                        {order.items?.map((item, index) => (
                          <div key={index} className="flex justify-between text-sm">
                            ...
                            {/* Ensure price is converted to string before parseFloat */}
                        ...
                        <div className="border-t pt-2 font-bold">
                          <div className="flex justify-between">
                            <span>Total:</span>
                            {/* Ensure total_amount is converted to string before parseFloat */}
                            <span className="text-orange-600">${parseFloat(order.total_amount.toString()).toFixed(2)}</span>
                          </div>
                        </div>
                      </div>
